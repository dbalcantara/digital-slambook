...
class SlambookPage extends StatefulWidget {
  @override
  _SlambookPageState createState() => _SlambookPageState();
}
...
class _SlambookPageState extends State<SlambookPage> {
  ...
  Widget build(BuildContext context) {
    final Map<String, dynamic> currentUser = context.read<FriendsProvider>().currentUser;
  ...
  Widget _column() {
    return Column(
      children: [
        _card(
          child: _textFieldForms(nameController, 'Name', Icons.person),
        ),
        const SizedBox(height: 5),
        _card(
          child: _textFieldForms(nicknameController, 'Nickname', Icons.tag),
        ),
        const SizedBox(height: 5),
        _card(
          child: _textFieldForms(
            ageController,
            'Age',
            Icons.cake,
          ),
  ...
  Widget _textFieldForms(TextEditingController controller, String label, IconData icon) {
  ...
  Widget _center(String title, String subtitle, Widget child) {
    return Center(
      child: _card(
        child: Column(
